--[[
	...
	Adapted to Deep Engine
	May 9th, 2021
]]

local module = {Priority = 1000}
...
function module:EngineInit()
	self.Services.MetronomeService:BindToFrequency(60, function(step)
		self:Heartbeat(step)
	end)
